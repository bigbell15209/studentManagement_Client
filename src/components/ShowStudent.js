...
function ShowStudent(props) {
  ...
  const deleteStudent = (id) => {
    ...
    const student = { firstName: data.firstName, lastName: data.lastName, 
      email: data.email,studentNumber: data.studentNumber, password: data.password, address: data.address ,city: data.city,phoneNumber: data.phoneNumber, program: data.program };
